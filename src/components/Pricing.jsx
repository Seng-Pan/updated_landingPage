...
import greenvd from '../assets/vdimg.png'
  ...
  return (
    <div className='md:px-14 p-4 max-w-s mx-auto py-10' id='pricing' >
        ...
        className='grid sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-20 md:w-11/12 mx-auto'>
            {
                packages.map((pkg,idx) => <div key={idx} className='border py-10 md:px-6 px-4 rounded-lg shadow-3xl'>
                    <h3 className='text-3xl font-bold text-center text-primary'>{pkg.name}</h3>
                    <p className='text-tartiary text-center my-5'>{pkg.description}</p>
                    <p className='mt-5 text-center text-[#2C6975] text-4xl font-bold' >
                    ...
                    <ul className='mt-4 space-y-2 px-4'>
                        <li className='flex gap-3 items-center'>
                            <img src={pkg.green} alt='' className='w-5 h-5 rounded-full' />Videos of Lessons
                        </li>
                        <li className='flex gap-3 items-center'>
                            <img src={pkg.green} alt='' className='w-5 h-5 rounded-full' />Homework check
                        </li>
                        <li className='flex gap-3 items-center'>
                            <img src={pkg.green} alt='' className='w-5 h-5 rounded-full' />Additional practical task
                        </li>
                        <li className='flex gap-3 items-center'>
                            <img src={pkg.green} alt='' className='w-5 h-5 rounded-full' />Monthly conferences
                        </li>
                        <li className='flex gap-3 items-center'>
                            <img src={pkg.green} alt='' className='w-5 h-5 rounded-full' />Personal advice from teachers
                        </li>
                    </ul>
